...

{
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(junction.locationX, locationX) == 0 && Double.compare(junction.locationY, locationY) == 0 && population == junction.population && name.equals(junction.name);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, locationX, locationY, population);
    }
