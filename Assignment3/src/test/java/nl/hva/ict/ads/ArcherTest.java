...
public class ArcherTest {
    ...
    void comparisonDifferentTotalScore() {
        ...
        System.out.println(archer1.getTotalScore() + "SCORE: " + archer4.getTotalScore());
        System.out.println(archer1.getId() + "ID: " + archer4.getId());
    ...
    void comparisonLessMissesIsWinner() {
        ...
        System.out.println(archer2.getTotalScore() + " SCORE: " + archer3.getTotalScore());
        System.out.println(archer2.getId() + " ID: " + archer3.getId());
    ...
    void comparisonFirstRegisteredIsWinner() {
        ...
        System.out.println(archer1.getTotalScore() + "SCORE: " + archer2.getTotalScore());
        System.out.println(archer1.getId() + "ID: " + archer2.getId());
